/*
 See: https://github.com/WestsideRobotics/FTC-Datalogging/wiki/Part-4,-Java-Learning-Exercise
...
public class DataLogger {
    ...
    private String directoryPath;       // path where datalog files are stored
    ...
    public DataLogger(String fileName) {
        ...
        directoryPath = "/sdcard/FIRST/java/src/Datalogs";
        ...
        int fileSerialNumber = nextFileSerialNumber();
        String filePath = directoryPath + "/" + fileName + String.format("%04d", fileSerialNumber) + ".txt";
    ...
    private int nextFileSerialNumber() {
        int result = getLastUsedSerialNumber();
        while (result > 9999) {
            result -= 10000;
        }

        updateSerialNumberFile(result);
        return result;
    }
    ...
    private void updateSerialNumberFile(int lastUsedSerialNumber) {
        String filePathName = serialNumberFileName();
